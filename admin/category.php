                ...
                <table class="table table-stripped">
                    ...
                    try {
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo '<td><a href="edit-category.php?cat_id=' . $cat_id . '"><button class="btn btn-default">Edit</button></a> <a href="delete-category.php?cat_id=' . $cat_id . '"><button class="btn btn-danger">Delete</button></a></td>';
                            echo "</tr>";
                        }

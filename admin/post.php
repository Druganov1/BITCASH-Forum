        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#"><span class="glyphicon glyphicon-user"></span> <?php echo htmlspecialchars($uname); ?></a></li>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <table class="table table-stripped">
                    ...
                    <th>Action</th>
                    <?php
                    $sql = "SELECT tp.post_Id, tp.title, c.category FROM tblpost as tp JOIN category as c ON tp.cat_id=c.cat_id";
